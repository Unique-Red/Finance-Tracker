...
class CSV:
    ...
    def get_transactions(cls, start_date, end_date):
        ...
        if filtered_df.empty:
            ...
            total_expense = filtered_df[filtered_df["category"] == "Rxpense"]["amount"].sum()
...
#     fig, ax = plt.subplots()
#     ax.bar(income["date"], income["amount"], color="g", label="Income")
#     ax.bar(expense["date"], expense["amount"], color="r", label="Expense")
